    ...
    <div className={style.background}>
      ...
      <div className={style.content}>
        ...
        <div className={style.content__right}>
          <img
            src="https://cdn.dribbble.com/users/623359/screenshots/9759917/media/65f2008952879ec1bab009b0730743fe.png?compress=1&resize=1200x900"
            alt="illustration"
          />
        </div>
      </div>
          ...
          <div className={style.testimony__item}>
            ...
            <div>
              ...
              <p>
                ...
                nostrum molestiae numquam doloribus. Harum voluptate autem
                molestias reiciendis necessitatibus consequatur illum debitis
                voluptas dignissimos, numquam doloribus provident sed sint
                commodi recusandae libero! Quidem facere fugit mollitia porro
                expedita modi veritatis voluptates ipsam ab voluptas! Ad natus a
                earum itaque odit.
              </p>
            </div>
          </div>
